...
Gem::Specification.new do |spec|
  ...
  spec.metadata['changelog_uri'] = 'https://github.com/deepakmahakale/rails_action_tracker/blob/master/CHANGELOG.md'
  ...
  # Development dependencies moved to Gemfile groups for better CI optimization
